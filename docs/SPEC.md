...
> AF-1 已實作的部分為**現況規格**;標示「AF-2」「AF-3」的段落仍是目標規格。
> AF-1 完成範圍:§1~§5、§8.1/§8.3(歷史查詢)、§9、§11、§12、§13,以及 §4.1 全部與 §4.2 預檢。
> 未實作:§6 自動登入的實際填入(只做登入頁判定)、§7 區塊聚合、§8.2 儀表板版面、§8.4/§8.5 內容、§10 告警。
